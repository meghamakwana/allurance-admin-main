...
const STATUS_OPTIONS = [{ value: 'all', label: 'All' }, { value: 'all', label: 'All' }];
...
export default function OrderListView({data}) {
  ...
  const getInvoiceLength = (status) => tableData.filter((item) => item.channel_mode === status).length;
              ...
              <Tab
                ...
                icon={
                  <Label
                    ...
                    color={
                      (tab.value === 'Offline' && 'success') ||
                      (tab.value === 'Online' && 'secondary') ||
                      'default'
                    }
                  >
                    {tab.count}
...
function applyFilter({ inputData, comparator, filters, dateError }) {
  ...
  if (status !== 'all') {
    ...
    inputData = inputData.filter((invoice) => invoice.channel_mode === filterInvoicesByStatus);
  }
