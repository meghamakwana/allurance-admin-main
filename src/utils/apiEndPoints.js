...
export const OTHER_ACTIVITY_ENDPOINT = `${apiUrl}/others/activitylog`; // Endpoint to manage other activity
...
export const LOGIN_ENDPOINT = `${apiUrl}/users/login`;
...
// ENDPOINT  TO UPLOAD THE DATA ON AZURE AS API
export const UPLOAD_FILE_TO_AZURE = `${apiUrl}/uploadtoazure`;
...
export const MARKETING_RMV_IMG_ENDPOINT = `${apiUrl}/marketing/marketingimg`;
export const MARKETING_FINAL_ENDPOINT = `${apiUrl}/marketing/finalproduct`;
...
export const PACKERS_SRNOBASEDBATCH_ENDPOINT = `${apiUrl}/packers/getsrnobasedonbatch`;
export const PACKERS_QUALITY_SERIAL_ON_BATCH = `${apiUrl}/packers_quality_packing/get_quality_serial_based_on_batch`;
export const PACKERS_MANAGER_BOXPACK_ADD = `${apiUrl}/packers_quality_packing/update_quality_serial_number`;
export const PACKERS_GET_QUALITY_REPORT = `${apiUrl}/packers_quality_packing/get_quality_reports`;
export const PACKERS_VERIFY_SERIAL_NUMBER = `${apiUrl}/packers_quality_packing/verify_serial_number`;
export const PACKING_UPDATE_SERIAL_NUMBER = `${apiUrl}/packers_quality_packing/update_packing_serial_number`;
export const PAKING_SERIAL_ON_BATCH = `${apiUrl}/packers_quality_packing/get_packing_serial_based_on_batch`;
export const PACKERS_GET_PACKING_REPORT = `${apiUrl}/packers_quality_packing/get_packing_reports`;
...
export const PACKERS_BOXPACK_REPORT_ENDPOINT = `${apiUrl}/packers/boxpack/report`;
export const PACKERS_CARTONS_LIST_IN_WAREHOUSE_ENDPOINT = `${apiUrl}/fetchrawproducts/fetchrawcartons`; // Endpoint to manage carton packing
...
export const WAREHOUSE_ADD_NAME = `${apiUrl}/warehouse_warehouse`;
export const WAREHOUE_RACKS_ENDPOINT = `${apiUrl}/warehouse_racks`;
export const WAREHOUE_BOXES_ENDPOINT = `${apiUrl}/warehouse_boxes`;
export const WAREHOUSE_BOXES_PACKERS_LISTING = `${apiUrl}/warehouse_boxes/packers_packing_listing`;
...
// REPORTS
export const REPORTS_LISTING = `${apiUrl}/reports`;

// MANAGE OFFLINE SALES
export const MANAGE_OFFLINE_SALES_SELECT_CHANNEL = `${apiUrl}/manage_offline_sales/selectchannel`;
export const MANAGE_OFFLINE_SALES_SUBMIT_SELECTED_CHANNEL = `${apiUrl}/manage_offline_sales/submitselectedchannel`;
export const MANAGE_OFFLINE_SALES_CHECK_USER = `${apiUrl}/manage_offline_sales/checkuser`;
export const MANAGE_OFFLINE_SALES_ADD_NEW_USER = `${apiUrl}/manage_offline_sales/addnewuser`;
export const MANAGE_OFFLINE_SALES_ALL_ADDRESS_LIST = `${apiUrl}/manage_offline_sales/fetchaddress`;
export const MANAGE_OFFLINE_SALES_ADD_NEW_ADDRESS = `${apiUrl}/manage_offline_sales/addnewaddress`;
export const MANAGE_OFFLINE_SALES_UPDATE_ADDRESS = `${apiUrl}/manage_offline_sales/submitaddress`;
export const MANAGE_OFFLINE_SALES_DELETE_ADDRESS = `${apiUrl}/manage_offline_sales/deleteaddress`;
export const MANAGE_OFFLINE_SALES_UPDATE_ORDER_TYPE = `${apiUrl}/manage_offline_sales/updateordertype`;
export const MANAGE_OFFLINE_SALES_LIST_OF_SERIAL_NUMBER = `${apiUrl}/manage_offline_sales/list_serial_number`;
export const MANAGE_OFFLINE_SALES_ADD_SERIAL_DATA = `${apiUrl}/manage_offline_sales/add_serial_number`;
export const MANAGE_OFFLINE_SALES_REMOVE_SERIAL_NUMBER = `${apiUrl}/manage_offline_sales/remove_serial_number`;
export const MANAGE_OFFLINE_SALES_PRODUCT_PREVIEW = `${apiUrl}/manage_offline_sales/product_preview`;
export const MANAGE_OFFLINE_SALES_PAYMENT_CONFIRMATION = `${apiUrl}/manage_offline_sales/payment_confirmation`;
export const MANAGE_OFFLINE_SALES_ORDER_DETAILS_AFTER_PAYMENT = `${apiUrl}/manage_offline_sales/order_details_after_payment`;
export const MANAGE_OFFLINE_SALES_FETCH_ALL_PRODUCT = `${apiUrl}/manage_offline_sales/fetch_all_products`;
